<template>
  <section>
    <div class="container _mgv-64px-sm _mgv-32px">
      <div class="row _mgbt-48px">
        <div class="col-12 _dp-b-sm _dp-f _fdrt-cl _alit-ct">
          <h1 class="_cl-dark _fw-bold _tal-ct _tal-l-sm">
            About <br class="_dp-b _dp-n-sm" />
            Able Logistics
          </h1>
          <div class="_bgcl-primary _w-64px _mgt-8px _h-4px _mgbt-32px"></div>
          <img src="../assets/images/heroabout.jpg" class="_w-100pct" alt="" />
          <h4 class="_cl-dark _mgt-48px _lh-150pct _tal-ct _fs-4-sm _fs-5">
      ...
      <div class="row  _alit-ct" id="story">
        ...
        <div class="col-sm-6 _mgt-64px-sm _pdt-32px order-sm-last order-first">
    ...
    <div class="force-full-width _bgcl-primary _mgt-64px">
      <div class="container _pdv-32px">
        <div class="row _bgcl-primary _pd-24px _jtfct-ct">
          <div class="col-sm-8">
            <h5 class="_lh-150pct _tal-ct">
